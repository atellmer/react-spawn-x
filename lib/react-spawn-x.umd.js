...
var connect = function connect(store) {
  return function (sectionState) {
    return function (ComponentFrom) {
        ...
        _createClass(ConnectWrapper, [{
          ...
          value: function componentWillMount() {
            ...
            Object.keys(sectionState).forEach(function (key) {
              store.detect(sectionState[key], function () {
                _this2.relevantState[key] = store.select(sectionState[key]);
                _this2.forceUpdate();
              });
            });
          }
          ...
          value: function render() {
            return _react2.default.createElement(ComponentFrom, _extends({}, this.props, this.relevantState));
          }
        }]);

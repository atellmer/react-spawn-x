      ...
      return function (_Component) {
        ...
        _createClass(ConnectWrapper, [{
          ...
          value: function componentWillMount() {
            ...
            Object.keys(selection).forEach(function (key) {
              if ((0, _helpers.isArray)(selection[key])) {
                _this2.resolve.apply(_this2, [key].concat(_toConsumableArray(selection[key])));
              } else {
                _this2.resolve(key, selection[key]);
              }
            });
          }
        }, {
          ...
          value: function resolve(key) {
            if ((arguments.length <= 1 ? 0 : arguments.length - 1) === 1 && (0, _helpers.isString)(arguments.length <= 1 ? undefined : arguments[1])) {
              this.detect(key, arguments.length <= 1 ? undefined : arguments[1], arguments.length <= 1 ? undefined : arguments[1]);
              return false;
            }
            if ((arguments.length <= 1 ? 0 : arguments.length - 1) > 1 && (0, _helpers.isString)(arguments.length <= 1 ? undefined : arguments[1]) && (0, _helpers.isFunc)(arguments.length <= 2 ? undefined : arguments[2])) {
              this.detect(key, arguments.length <= 1 ? undefined : arguments[1], arguments.length <= 2 ? undefined : arguments[2]);
              return false;
            } else {
          ...
          key: 'detect',
          value: function detect(key, zone, selector) {
            var _this3 = this;

            store.detect(zone, function () {
              _this3.relevantState[key] = store.select(selector);
              _this3.forceUpdate();
            });
          }
        }, {
...
exports.error = exports.isString = exports.isFunc = exports.isArray = undefined;
